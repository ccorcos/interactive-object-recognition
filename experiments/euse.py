...
from DL.models.EUSE import EUSE
...
errors = euse.errors()
params = flatten(euse.params)

print "training the EUSE with sgdem"
...
predict = theano.function(inputs=[o, a], outputs=euse.output)
