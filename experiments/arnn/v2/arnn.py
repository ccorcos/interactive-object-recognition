...
class RNN:
    ...
    def constructModel(self):
        ...
        self.predictorFF = ForwardFeed(n=self.n_hid, activation=T.tanh, name='predictorFF')
        ...
        def predictStep(h_t, a_t):
            k_t = self.predictiveStateLayer.compute([self.predictorFF.compute(h_t), self.actionFF.compute(a_t)])
            y_t = self.decoderFF.compute(k_t)
            return k_t, y_t
