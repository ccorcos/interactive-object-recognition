...
class Layer:
    def __init__(self, nin=None, nout=None, activation=T.tanh, name=''):
        """
...
class MultiInputLayer:
    def __init__(self, nins=[], nout=None, activation=T.tanh, name=''):
        """
        activation:           the activation function for the hidden layer
        name:                 name of the hidden layer
...
class ForwardFeed:
    def __init__(self, n=[], activation=T.tanh, outputActivation=None, name=''):
        """
        activation:        the activation function for the hidden layer
        name:              name of the hidden layer
